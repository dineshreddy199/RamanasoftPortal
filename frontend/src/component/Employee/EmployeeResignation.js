...
const EmployeeResignation = () => {
  const {user}=useAuth();
  const API_BASE_URL=process.env.REACT_APP_URL+'/employeeResignation';
...
const handleEdit = (employee) => {
  navigate('/Employee/EmployeeResignation/ApplyResignation', { state: { employee } });
};
  ...
  return (
    <>
      ...
      <div>
        <Link to="/Employee/EmployeeResignation/ApplyResignation">
          <button
            type="button"
