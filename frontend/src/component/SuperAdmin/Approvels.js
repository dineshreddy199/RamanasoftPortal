...
<div>
    ...
    <div className='bodyPage'>
      <div className='Card1 '>
                ...
                <p className='Card1-p'>New Employees Requests</p>
                <hr/>
                    <Link to='/SuperAdmin/Approvels/EmployeeRequest'>
                <button className='CardBtn'> 
                  ...
                  <div className='Card2'>
                      ...
                      <p className='Card1-p'>Leave Requests</p>
                      <hr/>
                      <Link to='/SuperAdmin/Approvels/LeaveRequest'>
                <button className='CardBtn'> 
                    <div className='Card1-btn-txt'>View  </div> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16" className='Card1-btn-Img'>
                      <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                ...
                <div className='Card3'>
                            <img src={RegistationDetails} alt='Registation-Image' className='Card1-Img'/>
                            <p  className='Card1-p'>Registation Requests</p>
                            <hr/>
                    <Link to='/SuperAdmin/Approvels/ResignationRequest'>
                <button className='CardBtn'> 
                    <div className='Card1-btn-txt'>View  </div> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16" className='Card1-btn-Img'>
                      <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
