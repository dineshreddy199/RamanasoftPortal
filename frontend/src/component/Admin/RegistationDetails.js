...
const handleEdit = (employee) => {
  navigate('/Admin/RegistationDetails/AddRegistationDetails', { state: { employee } });
};
  ...
  .filter(contact => contact.employeeId===user.employeeId)
  .filter(contact =>
  ...
  if (status === 'Approved') {
    ...
    return 'black'; // Default color if status is something else
  }
};
  ...
  return (
    <>
      ...
      <div className='Nav-txt'>List Of Registation Details</div>

      <div>
        <Link to="/Admin/RegistationDetails/AddRegistationDetails">
          <button
            type="button"
      ...
      <div className='Main-Box'>
        ...
        <div className='SearchBar'>
          <input
            ...
            />
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16"  className='SearchIcon'>
        ...
        <div className='TableHeader'>
          <div className='TableHeader-In'>
            ...
            <span style={{width:"464px",textAlign:"center"}}>Reason for Resigation </span>
            <span>status</span>
            <span>Action </span>
          </div>
        </div>
          ...
          {currentContacts.length === 0 ? (
            ...
            currentContacts.map((contact, index) => (
              <div className='TableBody-In' key={contact._id}>
                ...
                {/* <span>{contact.updatedAt[0,10]}</span> */}
                <span style={{width:'564px',textAlign:'center'}}>{contact.reason}</span>
                <span style={{ color: statusColor(contact.status) , fontWeight: 'bold'}}>{contact.status}</span>
                <span>
                  <button
        ...
        <div className='TableFooter'>
          <div className='TableFooter-In' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
             <button
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="29" fill="currentColor" class="bi bi-caret-left-fill" viewBox="0 0 16 16" className='FooterArrow'>
            ...
            <p style={{position:"relative",top:"0.45rem",color:"#402040"}}>
              ...
              >
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="29" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16" className='FooterArrow'>
