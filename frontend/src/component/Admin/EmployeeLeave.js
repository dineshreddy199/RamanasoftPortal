...
const ResignationRequest = () => {
  ...
  const handleEdit = (employee) => {
    navigate('/Admin/LeaveDetails/EmployeeLeave/AddEmployeeDetails', { state: { employee } });
  };
  ...
  return (
    <>
      ...
      <div className='Nav-txt'>Employee Leave Details</div>
        ...
        <div className='TableBody'>
              ...
              <div className='TableBody-In' id='EmployeeReq' key={contact._id}>
                ...
                <span>
                  {contact.status === 'Approved' || contact.status === 'Rejected' ? (
                      ...
                      <select
                        value={statusUpdates[contact._id] || contact.status || 'Pending'}
                        onChange={(e) => setStatusUpdates(prev => ({ ...prev, [contact._id]: e.target.value }))}
                        style={{ padding: '2px' }}
                      >
          ...
          <div style={{ textAlign: 'center', margin: '1rem 0' }}>
              <button
                ...
                style={{position:'absolute',top:"325px",left:"880px"}}
                onClick={async () => {
                  ...
                  setStatusUpdates({});
                  alert("Status updates submitted!");
                }}
